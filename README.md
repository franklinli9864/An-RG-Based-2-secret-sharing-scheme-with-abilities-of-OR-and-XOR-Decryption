...
1. 
**像素選取**：從第一張秘密 $SA$ 中選取像素 。


2. 
**加密產出**：透過指定演算法產生網格 $G1, G2$ 。
...
1. 
**環境需求**：Visual Studio 2022 與 OpenCV 4.x 。
...
3. 
**執行流程**：啟動程式後依照選單輸入演算法編號 (1-4) 以及位移參數 `num` (建議設為 4) 。
...
**還需要我幫你檢查 `Source.cpp` 中的其他邏輯，或是幫你撰寫一份 GitHub 專案的簡介嗎？**
